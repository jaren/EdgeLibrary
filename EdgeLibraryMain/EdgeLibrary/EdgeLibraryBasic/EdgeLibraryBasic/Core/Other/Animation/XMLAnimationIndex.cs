...
namespace EdgeLibrary
{
    ...
    public class XMLAnimationIndex : AnimationBase
    {
        ...
        public XMLAnimationIndex(int loopRate, string spriteSheet, string xmlPath) : base()
        {
            LoopRate = loopRate;
        ...
        public override void FillTexture()
        {
            try
            {
                SpriteSheet = ResourceData.getTexture(SpriteSheetData);
