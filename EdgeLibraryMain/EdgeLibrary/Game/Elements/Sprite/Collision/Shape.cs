...
namespace EdgeLibrary
{
    ...
    public class ShapeCircle : Shape
    {
        ...
        public override void DrawDebug(GameTime gameTime, SpriteBatch spriteBatch, Color color)
        {
            ...
            {
                spriteBatch.Draw(EdgeGame.GetCurrentGame().Resources.GetTexture("Pixel"), new Rectangle((int)point.X, (int)point.Y, 1, 1), color);
            }
        }
    }
    ...
    public class ShapeRectangle : Shape
    {
        ...
        public override void DrawDebug(GameTime gameTime, SpriteBatch spriteBatch, Color color)
        {
            ...
            spriteBatch.Draw(EdgeGame.GetCurrentGame().Resources.GetTexture("Pixel"), new Rectangle(rectangle.Top, rectangle.Left, 1, rectangle.Height), color);
            spriteBatch.Draw(EdgeGame.GetCurrentGame().Resources.GetTexture("Pixel"), new Rectangle(rectangle.Top, rectangle.Right, 1, rectangle.Height), color);
            spriteBatch.Draw(EdgeGame.GetCurrentGame().Resources.GetTexture("Pixel"), new Rectangle(rectangle.Top, rectangle.Left, rectangle.Width, 1), color);
            spriteBatch.Draw(EdgeGame.GetCurrentGame().Resources.GetTexture("Pixel"), new Rectangle(rectangle.Bottom, rectangle.Left, rectangle.Width, 1), color);
        }
    }
}
