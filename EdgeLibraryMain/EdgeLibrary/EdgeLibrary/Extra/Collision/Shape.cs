...
namespace EdgeLibrary
{
    ...
    public class ShapeCircle : Shape
    {
        ...
        public ShapeCircle(Vector2 position, float radius)
            : base(position, ShapeTypes.circle)
        {
            Radius = radius;
        }
    ...
    public class ShapeRectangle : Shape
    {
        ...
        public ShapeRectangle(Vector2 position, float width, float height)
            : base(position, ShapeTypes.rectangle)
        {
            Width = width;
            Height = height;
        }
