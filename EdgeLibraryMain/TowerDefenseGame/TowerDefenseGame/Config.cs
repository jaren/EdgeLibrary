...
namespace TowerDefenseGame
{
    public static class Config
    {
        ...
        public static List<EnemyData> Enemies = new List<EnemyData>()
        {
            ...
            new EnemyData(10000, 0.5f, 0, 100, 2, new List<EnemyData>(), "sun2", Vector2.One*1.5f, 50, "NOT just a normal enemy."),
            new EnemyData(1000,2,0,75,1, new List<EnemyData>(), "ufoRed", Vector2.One * 0.5f,50,"A slightly less normal enemy.")
        };
