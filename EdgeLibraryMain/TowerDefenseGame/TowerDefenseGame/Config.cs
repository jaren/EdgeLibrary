...
namespace TowerDefenseGame
{
        ...
        public static List<TowerData> Towers = new List<TowerData>()
    {
        ...
        new TowerData(1, 50, 500, 100, Projectiles[4], "enemyBlue3", MathHelper.ToRadians(180), Vector2.One, 400, "Homing"),
        new TowerData(100, 0, 800, 80, Projectiles[5], "enemyBlue4", MathHelper.ToRadians(0), Vector2.One, 400, "Fire"),
        new TowerData(200, 0, 800, 80, Projectiles[6], "enemyBlue5", MathHelper.ToRadians(180), Vector2.One, 40000, "(Happy Face)")
    };
