...
namespace EdgeLibrary.Unsupported
{
    ...
    public class ESAnimationIndex : AnimationBase
    {
        public Texture2D SpriteSheet;
        public string texturResourceData;
            ...
            : this()
        {
            ...
            texturResourceData = spriteSheet;
        }
        ...
        public override void FillTexture()
        {
            try
            {
                SpriteSheet = ResourceData.getTexture(texturResourceData);
