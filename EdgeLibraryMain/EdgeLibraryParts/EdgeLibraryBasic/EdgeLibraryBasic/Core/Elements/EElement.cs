...
namespace EdgeLibrary.Basic
{
    ...
    public class EElement : EObject
    {
        ...
        {
            spriteBatch.DrawString(font, text, Position, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, scale, effects, 0);
        }
        ...
        {
            spriteBatch.Draw(texture, bounds, origin, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, effects, 0);
        }
        ...
        protected void DrawToSpriteBatchWithScale(SpriteBatch spriteBatch, Rectangle? origin, Texture2D texture, float scale, Color color, float Rotation, SpriteEffects effects)
        {
            if (origin == null)
            {
                spriteBatch.Draw(texture, new Rectangle((int)(Position.X - texture.Width / 2 * scale), (int)(Position.Y - texture.Height / 2 * scale), (int)(texture.Width * scale), (int)(texture.Height * scale)), origin, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, effects, 0);
            }
            else
            {
                spriteBatch.Draw(texture, new Rectangle((int)(Position.X - ((Rectangle)origin).Width / 2 * scale), (int)(Position.Y - ((Rectangle)origin).Height / 2 * scale), (int)(((Rectangle)origin).Width * scale), (int)(((Rectangle)origin).Height * scale)), origin, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, effects, 0);
            }
        }
        ...
        protected void DrawToSpriteBatchWithWidth(SpriteBatch spriteBatch, Rectangle? origin, Texture2D texture, float width, Color color, float Rotation, SpriteEffects effects)
        {
            ...
            spriteBatch.Draw(texture, new Rectangle((int)(Position.X - width / 2), (int)(Position.Y - width * ratioWH / 2), (int)width, (int)(width * ratioWH)), origin, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, effects, 0);
        }
        ...
        protected void DrawToSpriteBatchWithHeight(SpriteBatch spriteBatch, Rectangle? origin, Texture2D texture, float height, Color color, float Rotation, SpriteEffects effects)
        {
            ...
            spriteBatch.Draw(texture, new Rectangle((int)(Position.X - height * ratioHW / 2), (int)(Position.Y - height / 2), (int)(height * ratioHW), (int)height), origin, color, MathHelper.ToDegrees(Rotation), Vector2.Zero, effects, 0);
        }
    }
}
