...
namespace EdgeLibrary.Basic
{
    ...
    class ESettingsHandler
    {
        List<EdgeSetting> settings;

        public ESettingsHandler(List<EdgeSetting> settingsToAdd)
        {
            settings = new List<EdgeSetting>(settingsToAdd);
        }

        public ESettingsHandler(params EdgeSetting[] settingsToAdd)
        {
            settings = new List<EdgeSetting>(settingsToAdd);
        }

        public ESettingsHandler(string xmlPath)
        {
